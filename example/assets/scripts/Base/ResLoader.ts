...
import { CompleteCallback, ICacheResInfo, LoadResArgs, ProgressCallback, ResUtils } from "./ResUtils";
...
export default class ResLoader extends cc.Component {
     ...
     * @param stack 堆栈信息
     */
    private _finishItem(item:cc.Asset, bundleName:string, use:string, stack:string) {
     ...
     * @param stack 堆栈信息
     */
    private _cacheItem(item:cc.Asset, bundleName:string, use:string, stack:string): boolean {
